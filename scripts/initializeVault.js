...
(async () => {
    ...
    const deployTx = await myContract.methods.initialize(200, '0xf736f43aAF66fBe3212156c48209295acD54F1Eb', 
    'CKBVault', 'CKBV', '0xf736f43aAF66fBe3212156c48209295acD54F1Eb'
).send({
